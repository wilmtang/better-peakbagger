...
- **Find and keep up with favorite climbers.** Custom favorites now show a live
  ...
  Peakbagger Buddy additions and removals now refresh the saved Buddy List after
  Peakbagger confirms the change. Additions also join a selected custom list,
  while removals preserve the favorite unless **Keep Buddy removals in sync**
  is enabled.
