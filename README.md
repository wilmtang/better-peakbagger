...
location without moving the route. In 3D, the compass follows the rotated map
while its absolute azimuth remains unchanged.
...
[Sun and Moon contract](docs/sun-position.md).
