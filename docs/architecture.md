...
flowchart TB
    ...
    subgraph peakbagger["Peakbagger tab"]
        ...
        main["MAIN-world coordinators<br/>GPX Analyzer, Peak map, BigMap<br/>offline Sun/Moon + page map state"]
...
That same authoritative point selection updates the offline Sun and Moon
calculator.
...
astronomy time slider has no reverse path into chart selection, Leaflet, or
terrain.
