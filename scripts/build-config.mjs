...
export const ENTRIES = [
    ...
    { out: 'content/climber-favorite.js', sources: ['settings/settings-schema.js', 'settings/settings.js', 'favorites/favorite-climbers.js', 'favorites/climber-favorite.js'] },
