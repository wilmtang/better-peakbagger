...
export const ENTRIES = [
    ...
    { out: 'content/ascent-backup.js', sources: ['peakbagger-cloudflare.js', 'peakbagger-response.js', 'peakbagger-error.js', 'peakbagger-request.js', 'profile-backup-core.js', 'report-markup.js', 'ascent-snapshot.js', 'ascent-backup-source.js', 'ascent-page.js', 'ascent-backup.js'] },
    ...
    { out: 'options/options.js', sources: ['terrain-cache.js', 'report-markup.js', 'report-drafts.js', 'favorite-climbers.js', 'peakbagger-cloudflare.js', 'peakbagger-response.js', 'peakbagger-error.js', 'peakbagger-request.js', 'profile-backup-core.js', 'options-main.js', 'options-drafts.js', 'options-favorites.js'], page: true },
