...
export const ENTRIES = [
    ...
    { out: 'provider-page.js', sources: ['capture/provider-url.js', 'capture/provider-response.js', 'capture/capture-error-policy.js', 'gpx/gpx-parse.js', 'net/request-deadline.js', 'capture/provider-page.js'] },
