...
export const ENTRIES = [
    ...
    { out: 'content/ascent-editor.js', sources: ['ascent-draft.js', 'gpx-parse.js', 'settings-schema.js', 'settings.js', 'ascent-upload.js', 'ascent-saved.js', 'report-markup.js', 'report-editor.js'] },
    ...
    { out: 'content/profile-backup.js', sources: ['profile-backup-core.js', 'ascent-snapshot.js', 'report-markup.js', 'profile-backup.js'] },
    ...
    { out: 'content/peak-map.js', sources: ['terrain-basemap.js', 'terrain-camera.js', 'terrain-compass.js', 'peak-markers.js', 'settings-schema.js', 'peak-map.js'] },
    { out: 'content/big-map-bridge.js', sources: ['settings-schema.js', 'settings.js', 'big-map-bridge.js'] },
    { out: 'content/big-map.js', sources: ['gpx-metrics.js', 'terrain-basemap.js', 'terrain-camera.js', 'terrain-compass.js', 'peak-markers.js', 'settings-schema.js', 'big-map.js'] },
