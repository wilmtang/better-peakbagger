...
test('ascent editor integration is isolated to Peakbagger and runtime code never names a Save control', async () => {
    ...
    assert.deepEqual(bundleSources('content/ascent-editor.js'),
        ['ui/units.js', 'ascent/ascent-draft.js', 'gpx/gpx-parse.js', 'settings/settings-schema.js', 'settings/settings.js', 'ascent/ascent-upload.js', 'ascent/ascent-saved.js', 'ascent/ascent-delete.js', 'reports/report-markup.js', 'reports/report-drafts.js', 'ui/dom.js', 'ui/runtime-message.js', 'reports/report-editor.js']);
