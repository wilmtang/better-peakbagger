...
test('the worker ships as one bundle for both Chrome and Firefox', () => {
    ...
    assert.deepEqual(bundleSources('background.js'),
        ['gpx-metrics.js', 'capture-core.js', 'provider-url.js', 'terrain-tiles.js', 'terrain-cache.js', 'settings-schema.js', 'settings.js', 'github-errors.js', 'github-api.js', 'github-auth.js', 'github-client.js', 'peakbagger-cloudflare.js', 'peakbagger-response.js', 'peakbagger-error.js', 'peakbagger-request.js', 'background.js']);
...
test('3D terrain is isolated from Peakbagger globals in an extension-owned frame', async () => {
    ...
    assert.deepEqual(bundleSources('content/gpx-analyzer.js'),
        ['gpx-metrics.js', 'terrain-basemap.js', 'terrain-camera.js', 'terrain-compass.js', 'terrain-coordinator.js', 'terrain-failure.js', 'peak-markers.js', 'peakbagger-cloudflare.js', 'peakbagger-response.js', 'peakbagger-error.js', 'peakbagger-request.js', 'settings-schema.js', 'gpx-analyzer.js']);
...
test('the ascent sorter also reaches the Buddy List report endpoint', () => {
    ...
    assert.deepEqual(bundleSources('content/ascent-filter.js'),
        ['settings-schema.js', 'settings.js', 'favorite-climbers.js', 'peakbagger-cloudflare.js', 'peakbagger-response.js', 'peakbagger-error.js', 'peakbagger-request.js', 'profile-backup-core.js', 'ascent-filter.js']);
...
test('full-profile backup is isolated to ClimbListC with its own bundled surface', () => {
    ...
    assert.deepEqual(entry.sources, ['peakbagger-cloudflare.js', 'peakbagger-response.js', 'peakbagger-error.js', 'peakbagger-request.js', 'profile-backup-core.js', 'ascent-snapshot.js', 'report-markup.js', 'ascent-backup-source.js', 'profile-backup.js']);
});
...
test('individual and profile backups bundle the same Peakbagger source reader', () => {
    ...
    assert.deepEqual(bundleSources('content/ascent-backup.js'),
        ['peakbagger-cloudflare.js', 'peakbagger-response.js', 'peakbagger-error.js', 'peakbagger-request.js', 'profile-backup-core.js', 'report-markup.js', 'ascent-snapshot.js', 'ascent-backup-source.js', 'ascent-page.js', 'ascent-backup.js']);
